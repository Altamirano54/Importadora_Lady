 ...
 * Author: Jheff
 */
public class ModeloTablaReporte_VentaPorMes extends AbstractTableModel {

    private final String[] columnas = {
        "Fecha", "Cantidad Ventas", "Ingresos Totales"
    };

    private ArrayList<ReporteVentaPorMes> listado;

    public ModeloTablaReporte_VentaPorMes() {
     ...
     * @param listado
     */
    public void setListado(ArrayList<ReporteVentaPorMes> listado) {
        this.listado = listado;
        fireTableDataChanged();
    }

    public ArrayList<ReporteVentaPorMes> getListado() {
        return listado;
    }
     ...
     * @return 
     */
    public ReporteVentaPorMes getItem(int fila) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ReporteVentaPorMes r = listado.get(rowIndex);
        switch (columnIndex) {
            case 0:
                return r.getFecha();
            case 1:
